...
<div id="wra">
	...
	<div id="bodybox">
		...
		<center>
         ...
         <h3>Pacientes por Medico</h3>			
			
<?php

include("conexion.php");
echo "<form action=pacientesxmedicom.php method=Post ENCTYPE=multipart/form-data>";
echo "<table border=1>";
echo "<tr>";
...
echo"</tr>";
    $sql="SELECT * FROM ingreso i JOIN paciente p ON i.codigoPaciente = p.cedula WHERE codigoMedico = '$codmed'";
    $resp=mysqli_query($conn,$sql);
